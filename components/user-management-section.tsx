  ...
  return (
    <div>
      <form onSubmit={createUser} className="rounded-2xl border bg-muted/20 p-4 sm:p-5">
        <div className="mb-4"><h3 className="text-sm font-bold">Adicionar alguém à sua empresa</h3><p className="mt-1 text-xs leading-5 text-muted-foreground">Crie um acesso para sua equipe. A pessoa entrará com a senha temporária e será obrigada a trocá-la.</p></div>
